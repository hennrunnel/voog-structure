...
const BuyDomain = () => {
  ...
  return <div className="min-h-screen bg-gray-50">
      <CartNotificationBar show={showNotification && cartItems.length > 0} itemCount={cartItems.length} onClose={() => setShowNotification(false)} onCheckout={handleCheckout} />
      ...
      <div className="flex flex-col items-center px-4 py-12">
        ...
        maxWidth: '992px'
          ...
          <div className="p-8">
            ...
            {hasSearched && <DomainResults results={searchResults} onAddToCart={addToCart} onRemoveFromCart={removeFromCart} />}
          </div>
        </div>
      </div>
    </div>;
