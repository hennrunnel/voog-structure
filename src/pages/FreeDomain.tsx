      ...
      <div className="flex flex-col items-center px-4 py-12">
        ...
        maxWidth: '992px'
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <Link to="/" className="flex items-center text-blue-600 hover:text-blue-700 mb-4 font-medium">
        ...
        maxWidth: '992px'
          ...
          <div className="p-8">
            <div className="mb-8">
                ...
                <div>
                  ...
                  <div className="mt-2 flex gap-3">
                    <div className="flex-1 relative">
                      <Input id="subdomain-search" type="text" value={subdomain} onChange={handleInputChange} placeholder="yourdomain" className="pr-20" />
                      <span className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-600">
                        .voog.com
                      </span>
                    </div>
                    <button type="submit" disabled={!isAvailable} className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white px-6 py-2 rounded-md font-medium transition-colors">
                      Take it!
                    </button>
                  </div>
                </div>
              ...
              {/* Validation Message */}
              {validationMessage && <div className={`mt-3 text-sm ${isAvailable ? 'text-green-600' : isTaken ? 'text-red-600' : ''}`}>
                  {validationMessage}
                </div>}
              
              {isValidating && <div className="mt-3 text-sm text-gray-600">
