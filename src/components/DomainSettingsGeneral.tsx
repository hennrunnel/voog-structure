...
export const DomainSettingsGeneral = ({
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-6">Domain Configuration</h3>
      ...
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-6">Domain Management</h3>
      ...
      {/* Save and Cancel buttons - Full width and grouped */}
      <div className="pt-8 space-y-3">
        <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 text-sm font-medium rounded-lg">
          Save
        </Button>
        <Button variant="outline" className="w-full bg-blue-50 text-blue-600 border-blue-200 hover:bg-blue-100 py-3 text-sm font-medium rounded-lg">
          Cancel
        </Button>
      </div>
    </div>
