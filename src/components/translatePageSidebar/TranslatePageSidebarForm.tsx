...
export const TranslatePageSidebarForm = ({
  ...
  return <div className="px-6 py-6 flex-1 overflow-y-auto">
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Input id="title" value={title} onChange={e => setTitle(e.target.value)} placeholder="Type here..." className="w-full border-border rounded-lg" aria-required="true" />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input id="address" value={address} onChange={e => handleAddressChange(e.target.value)} placeholder="/page-slug" className="w-full border-border rounded-lg" aria-required="true" />
        ...
        <div className="space-y-2">
          ...
          <Select value={duplicateFrom} onValueChange={setDuplicateFrom}>
            ...
            <SelectContent>
              ...
              {availableLanguages.map(language => <SelectItem key={language} value={language}>
        ...
        {showLayoutField && <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center space-x-2">
            <Switch id="show-in-menu" checked={visibility === "visible"} onCheckedChange={checked => setVisibility(checked ? "visible" : "hidden")} />
