...
const SettingsIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_85_13)">
      <path opacity="0.3" fillRule="evenodd" clipRule="evenodd" d="M4.5 7H9.5C10.3284 7 11 7.67157 11 8.5C11 9.32843 10.3284 10 9.5 10H4.5C3.67157 10 3 9.32843 3 8.5C3 7.67157 3.67157 7 4.5 7ZM13.5 15H18.5C19.3284 15 20 15.6716 20 16.5C20 17.3284 19.3284 18 18.5 18H13.5C12.6716 18 12 17.3284 12 16.5C12 15.6716 12.6716 15 13.5 15Z" fill="#1B2124"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M17 11C15.3431 11 14 9.65685 14 8C14 6.34315 15.3431 5 17 5C18.6569 5 20 6.34315 20 8C20 9.65685 18.6569 11 17 11ZM6 19C4.34315 19 3 17.6569 3 16C3 14.3431 4.34315 13 6 13C7.65685 13 9 14.3431 9 16C9 17.6569 7.65685 19 6 19Z" fill="#1B2124"/>
    </g>
    <defs>
