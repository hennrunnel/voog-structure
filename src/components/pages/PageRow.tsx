...
const ExternalLinkIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-50 hover:opacity-100 transition-opacity">
...
const ChevronIcon = ({ isExpanded }: { isExpanded: boolean }) => (
  <svg 
    ...
    className="transition-transform duration-200 opacity-50 hover:opacity-100"
  >
